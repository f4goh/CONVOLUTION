...
#define pinPLLACQ 9   //output *
//10 cs sdcard
//11 mosi
//12 miso
//13 sck
#define pinRXDCACQ 13    //output
#define pinCOSLED 10    //output *
#define pinDebugT 11     //output led1 emission de la trame gmsk
#define pinDebugR 12     //output led3 réception de la trame gmsk
